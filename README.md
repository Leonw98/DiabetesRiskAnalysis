...
📄 [Top Risk Features Table](tables/top_risk_features.csv)  
📄 [Top Protective Features Table](tables/top_protective_features.csv)
...
📄 [High-Risk Non-Diabetics](tables/stratified_incomegroup_vs_diabetes.csv)  
📄 [High-Risk Pre-Diabetics](tables/stratified_agegroup_vs_diabetes.csv)  
📄 [High-Risk Diabetics](tables/stratified_sex_vs_diabetes.csv)
...
- **Policy-ready insights**: Directly applicable to public-health strategy# 🩺 Diabetes Risk and Protective Factor Analysis
